...
import { PpeScheduleData } from '../../../types.ts';
            ...
            <div className="overflow-x-auto">
             ...
             {commitments && (
                <div className="text-xs mt-2">
                    ...
                    <p className="italic text-gray-500">{commitments}</p>
                </div>
            )}
            {pledgedAssets && (
                <div className="text-xs mt-2">
                    <p className="font-semibold text-gray-400">Assets Pledged as Security:</p>
                    <p className="italic text-gray-500">{pledgedAssets}</p>
                </div>
            )}
            {borrowingCostsCapitalized && (
                <div className="text-xs mt-2">
                    <p className="font-semibold text-gray-400">Borrowing Costs Capitalized (AS 16):</p>
                    <p className="italic text-gray-500">{borrowingCostsCapitalized}</p>
                </div>
            )}
        </div>
    );
