...
import { LoansAndAdvancesScheduleData, LoanAdvanceItem } from '../../types.ts';
...
export const LoansAndAdvancesSchedule: React.FC<LoansAndAdvancesScheduleProps> = ({ data, onUpdate, isFinalized }) => {
    ...
    const handleFieldUpdate = (field: keyof LoansAndAdvancesScheduleData, value: string) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="mt-4">
                 <label className="block text-sm font-medium text-gray-400">Allowance for bad and doubtful loans and advances</label>
                 <input
                    type="text"
                    value={data.allowanceForBadAndDoubtful}
                    onChange={(e) => handleFieldUpdate('allowanceForBadAndDoubtful', e.target.value)}
