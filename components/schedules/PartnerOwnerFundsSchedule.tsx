...
export const PartnerOwnerFundsSchedule: React.FC<PartnerOwnerFundsScheduleProps> = ({ title, data, onUpdate, isFinalized }) => {
    ...
    const addRow = (type: 'capitalAccount' | 'currentAccount') => {
        const newRow: PartnerAccountRow = { id: uuidv4(), partnerName: '', opening: '0', introduced: '0', remuneration: '0', interest: '0', withdrawals: '0', profitShare: '0', closing: '0', agreedContribution: '0', profitSharePercentage: '0' };
